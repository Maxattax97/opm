...
TL;DR you can concisely manage packages on any POSIX-compliant Linux/BSD environment with this one-liner:
```
(curl -sL tinyurl.com/ya2cm535||wget -qO- tinyurl.com/ya2cm535)|sh -s help
```
